...
namespace Norsys\BannerSlider\Block\Adminhtml\Slider\Edit\Tab;
...
use Norsys\BannerSlider\Block\Adminhtml\Banner\Edit\Tab\Render\GridImage;
use Norsys\BannerSlider\Block\Adminhtml\Banner\Edit\Tab\Render\Status;
use Norsys\BannerSlider\Block\Adminhtml\Banner\Edit\Tab\Render\Type;
use Norsys\BannerSlider\Model\BannerFactory;
use Norsys\BannerSlider\Model\ResourceModel\Banner\Collection;
use Norsys\BannerSlider\Model\ResourceModel\Banner\CollectionFactory as BannerCollectionFactory;

/**
 * Class Banner
 * @package Norsys\BannerSlider\Block\Adminhtml\Slider\Edit\Tab
 */
class Banner extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('norsys_bannerslider_banner_slider')],
    ...
    /**
     * @param \Norsys\BannerSlider\Model\Banner|Object $item
     *
     * @return string
     */
