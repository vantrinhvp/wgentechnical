...
class Banner extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->bannerSliderTable = $this->getTable('norsys_bannerslider_banner_slider');
    }
    ...
    {
        $this->_init('norsys_bannerslider_banner', 'banner_id');
    }
    ...
    /**
     * @param \Norsys\BannerSlider\Model\Banner $banner
     *
     * @return $this
     */
    protected function saveSliderRelation(\Norsys\BannerSlider\Model\Banner $banner)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'norsys_bannerslider_banner_after_save_sliders',
     ...
     * @return array
     */
    public function getSliderIds(\Norsys\BannerSlider\Model\Banner $banner)
    {
        $adapter = $this->getConnection();
        $select = $adapter->select()
