...
namespace Norsys\BannerSlider\Model\ResourceModel;
...
/**
 * Class Slider
 * @package Norsys\BannerSlider\Model\ResourceModel
 */
class Slider extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->sliderBannerTable = $this->getTable('norsys_bannerslider_banner_slider');
    }
    ...
    {
        $this->_init('norsys_bannerslider_slider', 'slider_id');
    }
     ...
     * after save callback
     *
     * @param AbstractModel|\Norsys\BannerSlider\Model\Slider $object
     *
     * @return AbstractDb
     */
    ...
    /**
     * @param \Norsys\BannerSlider\Model\Slider $slider
     *
     * @return array
     */
    public function getBannersPosition(\Norsys\BannerSlider\Model\Slider $slider)
    {
     ...
     * @return $this
     */
    protected function saveBannerRelation(\Norsys\BannerSlider\Model\Slider $slider)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'norsys_bannerslider_slider_after_save_banners',
