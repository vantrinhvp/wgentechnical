...
namespace Norsys\BannerSlider\Model;
...
use Norsys\BannerSlider\Model\Config\Source\Image as configImage;
use Norsys\BannerSlider\Model\ResourceModel\Banner as ResourceBanner;
use Norsys\BannerSlider\Model\ResourceModel\Slider\Collection;
use Norsys\BannerSlider\Model\ResourceModel\Slider\CollectionFactory as sliderCollectionFactory;
...
class Banner extends AbstractModel implements IdentityInterface
{
     ...
     * @var string
     */
    const CACHE_TAG = 'norsys_bannerslider_banner';
     ...
     * @var string
     */
    protected $_cacheTag = 'norsys_bannerslider_banner';
     ...
     * @var string
     */
    protected $_eventPrefix = 'norsys_bannerslider_banner';
    ...
    public function getSelectedSlidersCollection()
    {
        if ($this->sliderCollection === null) {
            ...
            $collection->getSelect()->join(
                ['banner_slider' => $this->getResource()->getTable('norsys_bannerslider_banner_slider')],
