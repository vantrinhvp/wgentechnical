...
class Slider extends AbstractModel implements IdentityInterface
{
     ...
     * @var string
     */
    const CACHE_TAG = 'norsys_bannerslider_slider';
     ...
     * @var string
     */
    protected $_cacheTag = 'norsys_bannerslider_slider';
     ...
     * @var string
     */
    protected $_eventPrefix = 'norsys_bannerslider_slider';
    ...
    {
        $this->_init('Norsys\BannerSlider\Model\ResourceModel\Slider');
    }
