...
namespace Norsys\BannerSlider\Setup;
...
use Norsys\BannerSlider\Model\Config\Source\Template;
use Psr\Log\LoggerInterface;
use Zend_Db_Exception;

/**
 * Class InstallSchema
 * @package Norsys\BannerSlider\Setup
 */
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (!$installer->tableExists('norsys_bannerslider_banner')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('norsys_bannerslider_banner'))
                ->addColumn(
                    'banner_id',
                    Table::TYPE_INTEGER,
                    null,
            ...
            $installer->getConnection()->addIndex(
                $installer->getTable('norsys_bannerslider_banner'),
                $setup->getIdxName(
                    $installer->getTable('norsys_bannerslider_banner'),
        ...
        if (!$installer->tableExists('norsys_bannerslider_slider')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('norsys_bannerslider_slider'))
                ->addColumn(
                    'slider_id',
                    Table::TYPE_INTEGER,
                    null,
        ...
        if (!$installer->tableExists('norsys_bannerslider_banner_slider')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('norsys_bannerslider_banner_slider'))
                ->addColumn(
                    'slider_id',
                    Table::TYPE_INTEGER,
                    null,
                ...
                ->addIndex($installer->getIdxName('norsys_bannerslider_banner_slider', ['slider_id']), ['slider_id'])
                ->addIndex($installer->getIdxName('norsys_bannerslider_banner_slider', ['banner_id']), ['banner_id'])
                ->addForeignKey(
                    $installer->getFkName(
                        'norsys_bannerslider_banner_slider',
                        'slider_id',
                        'norsys_bannerslider_slider',
                        'slider_id'
                    ),
                    'slider_id',
                    $installer->getTable('norsys_bannerslider_slider'),
                    'slider_id',
    ...
    private function copyDemoImage()
    {
        try {
            ...
            $url = 'norsys/bannerslider/banner/demo/';
