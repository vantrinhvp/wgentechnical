...
use Norsys\BannerSlider\Model\Config\Source\Effect;
use Norsys\BannerSlider\Model\ResourceModel\Banner\Collection;
use Norsys\BannerSlider\Model\Slider;
use Norsys\BannerSlider\Model\SliderFactory;
use Norsys\Backend\Helper\AbstractData;

/**
 * Class Data
 * @package Norsys\BannerSlider\Helper
 */
class Data extends AbstractData
{
    ...
    public function getBannerCollection($id = null)
    {
        ...
        $collection->join(
            ['banner_slider' => $collection->getTable('norsys_bannerslider_banner_slider')],
    ...
    /**
     * @return \Norsys\BannerSlider\Model\ResourceModel\Slider\Collection
     * @throws NoSuchEntityException
     */
    public function getActiveSliders()
    {
        /** @var \Norsys\BannerSlider\Model\ResourceModel\Slider\Collection $collection */
